...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 7AA2B21E227
	for <lists+linux-efi@lfdr.de>; Mon, 13 Jul 2020 23:31:47 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726963AbgGMVbF (ORCPT <rfc822;lists+linux-efi@lfdr.de>);
        Mon, 13 Jul 2020 17:31:05 -0400
Received: from mx0b-002e3701.pphosted.com ([148.163.143.35]:8362 "EHLO
        mx0b-002e3701.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1726831AbgGMVbD (ORCPT
        <rfc822;linux-efi@vger.kernel.org>); Mon, 13 Jul 2020 17:31:03 -0400
Received: from pps.filterd (m0148664.ppops.net [127.0.0.1])
        by mx0b-002e3701.pphosted.com (8.16.0.42/8.16.0.42) with SMTP id 06DLGk81031350;
        Mon, 13 Jul 2020 21:29:59 GMT
Received: from g2t2354.austin.hpe.com (g2t2354.austin.hpe.com [15.233.44.27])
        by mx0b-002e3701.pphosted.com with ESMTP id 328ux71edb-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT);
        Mon, 13 Jul 2020 21:29:58 +0000
Received: from stormcage.eag.rdlabs.hpecorp.net (stormcage.eag.rdlabs.hpecorp.net [128.162.236.70])
        by g2t2354.austin.hpe.com (Postfix) with ESMTP id AB5C681;
        Mon, 13 Jul 2020 21:29:56 +0000 (UTC)
Received: by stormcage.eag.rdlabs.hpecorp.net (Postfix, from userid 200934)
        id 1225D20099B3B; Mon, 13 Jul 2020 16:29:55 -0500 (CDT)
Message-ID: <20200713212954.964332370@hpe.com>
User-Agent: quilt/0.66
Date:   Mon, 13 Jul 2020 16:29:58 -0500
...
Subject: [patch v3 04/13] x86: Remove support for UV1 platform from uv_mmrs.h
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 suspectscore=0 bulkscore=0
 ...
 lowpriorityscore=0 impostorscore=0 phishscore=0 mlxscore=0 mlxlogscore=729
...
--- linux.orig/arch/x86/include/asm/uv/uv_mmrs.h	2020-07-07 10:49:50.301510334 -0500
+++ linux/arch/x86/include/asm/uv/uv_mmrs.h	2020-07-07 10:56:14.053047127 -0500
@@ -19,7 +19,6 @@
  *
...
@@ -107,12 +90,10 @@ extern unsigned long uv_undefined(char *
 /* ========================================================================= */
...
-	} s1;
 	struct uv2h_lb_bau_intd_payload_queue_first_s {
 		unsigned long	rsvd_0_3:4;
 		unsigned long	address:39;			/* RW */
@@ -1906,22 +1583,16 @@ union uvh_lb_bau_intd_payload_queue_firs
 /* ========================================================================= */
...
@@ -1931,11 +1602,6 @@ union uvh_lb_bau_intd_payload_queue_firs
...
-	} s1;
 	struct uv2h_lb_bau_intd_payload_queue_last_s {
 		unsigned long	rsvd_0_3:4;
 		unsigned long	address:39;			/* RW */
@@ -1951,22 +1617,16 @@ union uvh_lb_bau_intd_payload_queue_last
 /* ========================================================================= */
...
@@ -1976,11 +1636,6 @@ union uvh_lb_bau_intd_payload_queue_last
...
-	} s1;
 	struct uv2h_lb_bau_intd_payload_queue_tail_s {
 		unsigned long	rsvd_0_3:4;
 		unsigned long	address:39;			/* RW */
@@ -1996,52 +1651,16 @@ union uvh_lb_bau_intd_payload_queue_tail
 /* ========================================================================= */
...
@@ -2111,25 +1730,6 @@ union uvh_lb_bau_intd_payload_queue_tail
...
@@ -2173,12 +1773,10 @@ union uvh_lb_bau_intd_software_acknowled
 /* ========================================================================= */
...
@@ -2188,22 +1786,18 @@ union uvh_lb_bau_intd_software_acknowled
 /* ========================================================================= */
...
@@ -2237,39 +1831,6 @@ union uvh_lb_bau_intd_software_acknowled
...
@@ -2469,28 +2030,24 @@ union uvh_lb_bau_intd_software_acknowled
...
@@ -2723,22 +2253,18 @@ union uvh_lb_bau_sb_activation_status_0_
 /* ========================================================================= */
...
@@ -2757,32 +2283,24 @@ union uvh_lb_bau_sb_activation_status_1_
 /* ========================================================================= */
...
@@ -2800,21 +2318,18 @@ union uvh_lb_bau_sb_activation_status_1_
...
@@ -2824,7 +2339,6 @@ union uvh_lb_bau_sb_activation_status_1_
 /*                               UVH_NODE_ID                                 */
 /* ========================================================================= */
...
@@ -2840,21 +2354,6 @@ union uvh_lb_bau_sb_activation_status_1_
...
@@ -3088,14 +2564,6 @@ union uvh_rh_gam_alias210_overlay_config
...
-	} s1;
 	struct uvxh_rh_gam_alias210_overlay_config_0_mmr_s {
 		unsigned long	rsvd_0_23:24;
 		unsigned long	base:8;				/* RW */
@@ -3133,12 +2601,10 @@ union uvh_rh_gam_alias210_overlay_config
 /* ========================================================================= */
...
@@ -3150,13 +2616,6 @@ union uvh_rh_gam_alias210_overlay_config
...
@@ -3196,14 +2655,6 @@ union uvh_rh_gam_alias210_overlay_config
 		unsigned long	rsvd_53_62:10;
 		unsigned long	enable:1;			/* RW */
 	} s;
...
-	} s1;
 	struct uvxh_rh_gam_alias210_overlay_config_1_mmr_s {
 		unsigned long	rsvd_0_23:24;
 		unsigned long	base:8;				/* RW */
@@ -3241,12 +2692,10 @@ union uvh_rh_gam_alias210_overlay_config
 /* ========================================================================= */
...
@@ -3258,13 +2707,6 @@ union uvh_rh_gam_alias210_overlay_config
...
@@ -3304,14 +2746,6 @@ union uvh_rh_gam_alias210_overlay_config
 		unsigned long	rsvd_53_62:10;
 		unsigned long	enable:1;			/* RW */
 	} s;
...
-	} s1;
 	struct uvxh_rh_gam_alias210_overlay_config_2_mmr_s {
 		unsigned long	rsvd_0_23:24;
 		unsigned long	base:8;				/* RW */
@@ -3349,12 +2783,10 @@ union uvh_rh_gam_alias210_overlay_config
 /* ========================================================================= */
...
@@ -3362,9 +2794,6 @@ union uvh_rh_gam_alias210_overlay_config
...
@@ -3385,11 +2814,6 @@ union uvh_rh_gam_alias210_redirect_confi
...
-	} s1;
 	struct uvxh_rh_gam_alias210_redirect_config_0_mmr_s {
 		unsigned long	rsvd_0_23:24;
 		unsigned long	dest_base:22;			/* RW */
@@ -3415,12 +2839,10 @@ union uvh_rh_gam_alias210_redirect_confi
 /* ========================================================================= */
...
@@ -3428,9 +2850,6 @@ union uvh_rh_gam_alias210_redirect_confi
...
@@ -3451,11 +2870,6 @@ union uvh_rh_gam_alias210_redirect_confi
 		unsigned long	dest_base:22;			/* RW */
 		unsigned long	rsvd_46_63:18;
 	} s;
...
-	} s1;
 	struct uvxh_rh_gam_alias210_redirect_config_1_mmr_s {
 		unsigned long	rsvd_0_23:24;
 		unsigned long	dest_base:22;			/* RW */
@@ -3481,12 +2895,10 @@ union uvh_rh_gam_alias210_redirect_confi
 /* ========================================================================= */
...
@@ -3494,9 +2906,6 @@ union uvh_rh_gam_alias210_redirect_confi
...
@@ -3517,11 +2926,6 @@ union uvh_rh_gam_alias210_redirect_confi
 		unsigned long	dest_base:22;			/* RW */
 		unsigned long	rsvd_46_63:18;
 	} s;
...
-	} s1;
 	struct uvxh_rh_gam_alias210_redirect_config_2_mmr_s {
 		unsigned long	rsvd_0_23:24;
 		unsigned long	dest_base:22;			/* RW */
@@ -3547,12 +2951,10 @@ union uvh_rh_gam_alias210_redirect_confi
 /* ========================================================================= */
...
@@ -3560,13 +2962,6 @@ union uvh_rh_gam_alias210_redirect_confi
...
@@ -3694,16 +3069,6 @@ union uvh_rh_gam_gru_overlay_config_mmr_
...
@@ -3742,12 +3107,10 @@ union uvh_rh_gam_gru_overlay_config_mmr_
 /* ========================================================================= */
...
@@ -3823,12 +3186,10 @@ union uvh_rh_gam_mmioh_overlay_config0_m
 /* ========================================================================= */
...
@@ -3898,27 +3259,15 @@ union uvh_rh_gam_mmioh_overlay_config1_m
 /* ========================================================================= */
...
@@ -3931,14 +3280,6 @@ union uvh_rh_gam_mmioh_overlay_config1_m
...
@@ -3952,22 +3293,18 @@ union uvh_rh_gam_mmioh_overlay_config_mm
 /* ========================================================================= */
...
@@ -4005,22 +3342,18 @@ union uvh_rh_gam_mmioh_redirect_config0_
 /* ========================================================================= */
...
@@ -4058,12 +3391,10 @@ union uvh_rh_gam_mmioh_redirect_config1_
 /* ========================================================================= */
...
@@ -4073,13 +3404,6 @@ union uvh_rh_gam_mmioh_redirect_config1_
...
@@ -4109,13 +3433,6 @@ union uvh_rh_gam_mmr_overlay_config_mmr_
...
-	} s1;
 	struct uvxh_rh_gam_mmr_overlay_config_mmr_s {
 		unsigned long	rsvd_0_25:26;
 		unsigned long	base:20;			/* RW */
@@ -4145,12 +3462,10 @@ union uvh_rh_gam_mmr_overlay_config_mmr_
 /* ========================================================================= */
 /*                                 UVH_RTC                                   */
 /* ========================================================================= */
...
@@ -4719,23 +4024,6 @@ union uvxh_lb_bau_sb_activation_status_2
 };
