...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 5BAF81381C3
	for <lists+linux-efi@lfdr.de>; Sat, 11 Jan 2020 15:57:40 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1730101AbgAKO5b (ORCPT <rfc822;lists+linux-efi@lfdr.de>);
        Sat, 11 Jan 2020 09:57:31 -0500
Received: from us-smtp-1.mimecast.com ([205.139.110.61]:45256 "EHLO
        us-smtp-delivery-1.mimecast.com" rhost-flags-OK-OK-OK-FAIL)
        by vger.kernel.org with ESMTP id S1730084AbgAKO5b (ORCPT
        <rfc822;linux-efi@vger.kernel.org>); Sat, 11 Jan 2020 09:57:31 -0500
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=redhat.com;
        s=mimecast20190719; t=1578754648;
        h=from:from:reply-to:subject:subject:date:date:message-id:message-id:
         to:to:cc:cc:mime-version:mime-version:
         content-transfer-encoding:content-transfer-encoding:
         in-reply-to:in-reply-to:references:references;
        bh=Nw+q9Vocbw1z02K/yuKiEnrFBIluCagl47ja+cmkztk=;
        b=aKp1frFkOCoZnl5IfWuPZlNX5FtAugZ6pfT1MjeiznBdETXzdjx9X3iydTv3Gt9GiHkdG8
        Hp04Z8dU3iS6q56aY+9mcKMIw4Bw5wzzCk0eGAw5lJgTCzsOu4X4QJjukbZJN0BMdOvjjZ
        qqXzIYmHeMafkGwHqYdm5tTNI48c7M0=
Received: from mimecast-mx01.redhat.com (mimecast-mx01.redhat.com
 [209.132.183.4]) (Using TLS) by relay.mimecast.com with ESMTP id
 us-mta-380-9WpT4WhsM6imec2xQMOElg-1; Sat, 11 Jan 2020 09:57:27 -0500
X-MC-Unique: 9WpT4WhsM6imec2xQMOElg-1
Received: from smtp.corp.redhat.com (int-mx03.intmail.prod.int.phx2.redhat.com [10.5.11.13])
        (using TLSv1.2 with cipher AECDH-AES256-SHA (256/256 bits))
        (No client certificate requested)
        by mimecast-mx01.redhat.com (Postfix) with ESMTPS id AC6B410054E3;
        Sat, 11 Jan 2020 14:57:24 +0000 (UTC)
Received: from shalem.localdomain.com (ovpn-116-84.ams2.redhat.com [10.36.116.84])
        by smtp.corp.redhat.com (Postfix) with ESMTP id 0588587EC6;
...
Subject: [PATCH v11 04/10] firmware: Add new platform fallback mechanism and firmware_request_platform()
Date:   Sat, 11 Jan 2020 15:56:57 +0100
Message-Id: <20200111145703.533809-5-hdegoede@redhat.com>
...
+		return rc;
+
+	rc =3D efi_get_embedded_fw(fw_priv->fw_name, &fw_priv->data,
+				 &fw_priv->size);
+	if (rc)
