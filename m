...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id 3A5661323A6
	for <lists+linux-efi@lfdr.de>; Tue,  7 Jan 2020 11:33:49 +0100 (CET)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1727858AbgAGKdt (ORCPT <rfc822;lists+linux-efi@lfdr.de>);
        Tue, 7 Jan 2020 05:33:49 -0500
Received: from mail.kernel.org ([198.145.29.99]:40396 "EHLO mail.kernel.org"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726565AbgAGKds (ORCPT <rfc822;linux-efi@vger.kernel.org>);
        Tue, 7 Jan 2020 05:33:48 -0500
Received: from localhost.localdomain (amontpellier-657-1-18-247.w109-210.abo.wanadoo.fr [109.210.65.247])
        (using TLSv1.2 with cipher ECDHE-RSA-AES128-GCM-SHA256 (128/128 bits))
        (No client certificate requested)
        by mail.kernel.org (Postfix) with ESMTPSA id B9F88207E0;
        Tue,  7 Jan 2020 10:33:45 +0000 (UTC)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/simple; d=kernel.org;
        s=default; t=1578393227;
        bh=XGJL6+7PFDAZbcELXLyysCltHPLBnyTeWyQO/5hLWRk=;
        h=From:To:Cc:Subject:Date:From;
        b=LmPw4jeVRCNIQ09NqKSCE8gqxe93mL/ADLOop+z2F/xHms3PHBrN/DUAsKFDbbwaL
         jqZQwFsifPF8E9ZXZOlJa07wzatIyBtH0q9nPQBBWDGWvJAQL8iWzHBCOG29EFhgE2
         u99WD4cd9MQY+F8nHw1hBpneUrVTCWyXXGSSOubw=
From:   Ard Biesheuvel <ardb@kernel.org>
To:     linux-efi@vger.kernel.org
Cc:     mingo@kernel.org, Ard Biesheuvel <ardb@kernel.org>,
        Russ Anderson <rja@hpe.com>, Borislav Petkov <bp@alien8.de>,
        Dave Young <dyoung@redhat.com>,
        Dimitri Sivanich <dimitri.sivanich@hpe.com>,
        Mike Travis <mike.travis@hpe.com>,
        Hedi Berriche <hedi.berriche@hpe.com>
Subject: [PATCH v2] efi/x86: limit EFI old memory map to SGI UV machines
Date:   Tue,  7 Jan 2020 11:33:05 +0100
Message-Id: <20200107103305.22077-1-ardb@kernel.org>
...
index a974f8a17f73..0eb954a2dc5f 100644
...
+	if (efi_have_uv1_memmap())
 	...
 	/*
@@ -436,7 +308,7 @@ void __init efi_map_region(efi_memory_desc_t *md)
...
+	if (efi_have_uv1_memmap())
 	...
 	/*
@@ -493,26 +365,6 @@ void __init efi_map_region_fixed(efi_memory_desc_t *md)
...
@@ -561,7 +413,7 @@ void __init efi_runtime_update_mappings(void)
 {
 	efi_memory_desc_t *md;
...
+	if (efi_have_uv1_memmap()) {
 		...
 		return;
@@ -615,7 +467,7 @@ void __init efi_runtime_update_mappings(void)
...
@@ -1042,8 +894,8 @@ efi_status_t __init efi_set_virtual_address_map(unsigned long memory_map_size,
 							 descriptor_version,
 							 virtual_map);
...
@@ -1062,7 +914,7 @@ efi_status_t __init efi_set_virtual_address_map(unsigned long memory_map_size,
 	kernel_fpu_end();
