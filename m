 ...
 <63c54a85-3fe3-4e52-885c-ae5816e6b289@linux.intel.com>
In-Reply-To: <63c54a85-3fe3-4e52-885c-ae5816e6b289@linux.intel.com>
From: Dionna Amalie Glaze <dionnaglaze@google.com>
Date: Tue, 5 Mar 2024 13:28:42 -0800
Message-ID: <CAAH4kHYB3Ti=dDzY6K+wvvzTBE3DZui7Thm_dpd7jnN=DFUFhg@mail.gmail.com>
...
On Tue, Mar 5, 2024 at 11:36=E2=80=AFAM Kuppuswamy Sathyanarayanan
...
> >> host (like implementing it part of firmware or launching it as  servic=
e in
> >> a separate VM).
> >>
> >>>>>> +               efi_guid_t cc_guid =3D EFI_CC_MEASUREMENT_PROTOCOL=
_GUID;
> >>>>>> +               efi_cc_protocol_t *cc =3D NULL;
> >>>>>>
> >>>>>> -               evt->tagged_event_id            =3D events[event].=
event_id;
> >>>>>> -               evt->tagged_event_data_size     =3D events[event].=
event_data_len;
> >>>>>> -
> >>>>>> -               memcpy(evt->tagged_event_data, events[event].event=
_data,
> >>>>>> -                      events[event].event_data_len);
...
> >>>>>>
> >>>>>> -               status =3D efi_call_proto(tcg2, hash_log_extend_ev=
ent, 0,
...
> >>>>>> +                       .event_size                     =3D size,
> >>>>>> +                       .event_header.header_size       =3D sizeof=
(ev.cc_data.event_header),
> >>>>>> +                       .event_header.header_version    =3D EFI_CC=
...
> >>>>>> +               protocol =3D cc;
> >>>>>> +               method.hash_log_extend_event =3D
> >>>>>> +                       (void *)efi_table_attr(cc, hash_log_extend=
_event);
> >>>>>>         }
> >>>>>>
> >>>>>> -       return EFI_UNSUPPORTED;
> >>>>>> +       status =3D efi_bs_call(allocate_pool, EFI_LOADER_DATA, siz=
e, (void **)&evt);
> >>>>>> +       if (status !=3D EFI_SUCCESS)
> >>>>>> +               goto fail;
> >>>>>> +
...
;
> >>>>>> +       evt->tagged_event_data_size     =3D events[event].event_da=
ta_len;
> >>>>>> +
> >>>>>> +       memcpy(evt->tagged_event_data, events[event].event_data,
> >>>>>> +              events[event].event_data_len);
> >>>>>> +
> >>>>>> +       status =3D efi_fn_call(&method, hash_log_extend_event, pro=
tocol, 0,
> >>>>>> +                            load_addr, load_size, &evt->event_dat=
a);
> >>>>>> +       efi_bs_call(free_pool, evt);
> >>>>>> +
...
vent, status);
> >>>>>>         return status;
> >>>>>> diff --git a/drivers/firmware/efi/libstub/efistub.h b/drivers/firm=
ware/efi/libstub/efistub.h
...
> >>>>>>  };
> >>>>>>
> >>>>>> +static_assert(sizeof(efi_tcg2_event_t) =3D=3D sizeof(efi_cc_event=
_t));
> >>>>>> +
> >>>>>>  union efistub_event {
