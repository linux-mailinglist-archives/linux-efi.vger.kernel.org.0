...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id C920241BD5B
	for <lists+linux-efi@lfdr.de>; Wed, 29 Sep 2021 05:24:59 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S243983AbhI2D0i (ORCPT <rfc822;lists+linux-efi@lfdr.de>);
        Tue, 28 Sep 2021 23:26:38 -0400
Received: from lindbergh.monkeyblade.net ([23.128.96.19]:33256 "EHLO
        lindbergh.monkeyblade.net" rhost-flags-OK-OK-OK-OK) by vger.kernel.org
        with ESMTP id S243970AbhI2D0h (ORCPT
        <rfc822;linux-efi@vger.kernel.org>); Tue, 28 Sep 2021 23:26:37 -0400
Received: from mail-ua1-x934.google.com (mail-ua1-x934.google.com [IPv6:2607:f8b0:4864:20::934])
        by lindbergh.monkeyblade.net (Postfix) with ESMTPS id 0F9CFC06161C;
        Tue, 28 Sep 2021 20:24:57 -0700 (PDT)
Received: by mail-ua1-x934.google.com with SMTP id 64so529308uab.12;
        Tue, 28 Sep 2021 20:24:57 -0700 (PDT)
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        d=gmail.com; s=20210112;
        h=mime-version:references:in-reply-to:from:date:message-id:subject:to
         :cc;
        bh=Yo61N0FY4HHpBoqodxg9iCY5hIgG1TKOCcN8xuVwk8g=;
        b=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=Yo61N0FY4HHpBoqodxg9iCY5hIgG1TKOCcN8xuVwk8g=;
        b=
X-Gm-Message-State: AOAM5308DdrrFn1F2er4ngHbJqbM3D2Q9xtlGeOui+Zm8qbCDgFHZYcw
        jC3P4akP1JZ+5t56/w1pnbGdkV6J5DpY0u6ZkZ8=
X-Google-Smtp-Source: ABdhPJySURjXkx7ElTKFDVgO7A5+3t0DFWBmBYMYNw6JSPsW+gLd+cXaTN0gK/GhzpieZZ6kGPR20qf8WNqFpgb8qII=
X-Received: by 2002:ab0:550f:: with SMTP id t15mr8355553uaa.22.1632885895702;
 Tue, 28 Sep 2021 20:24:55 -0700 (PDT)
MIME-Version: 1.0
References: <20210927064300.624279-1-chenhuacai@loongson.cn>
 <20210927064300.624279-10-chenhuacai@loongson.cn> <CAMj1kXGmrTvgE60NDfx+v=woC7cfuSg=1fTv7T7gntLEEvTnDw@mail.gmail.com>
In-Reply-To: <CAMj1kXGmrTvgE60NDfx+v=woC7cfuSg=1fTv7T7gntLEEvTnDw@mail.gmail.com>
From:   Huacai Chen <chenhuacai@gmail.com>
Date:   Wed, 29 Sep 2021 11:24:42 +0800
Message-ID: <CAAhV-H5SO8_ufaCw3BL-20D6uuUBRO35uqA27B1AFm97LZtLHQ@mail.gmail.com>
Subject: Re: [PATCH V4 09/22] LoongArch: Add boot and setup routines
...
On Mon, Sep 27, 2021 at 2:53 PM Ard Biesheuvel <ardb@kernel.org> wrote:
>
> On Mon, 27 Sept 2021 at 08:49, Huacai Chen <chenhuacai@loongson.cn> wrote:
> >
...
> >
>
> Could you please quote the relevant sections of the UEFI and ACPI
> specifications where this boot protocol is described?
There is no UEFI/ACPI spec. sections to describe this. Maybe I misused
the "boot protocol" terminology here, we use UEFI firmware to load the
elf format kernel (not efistub), the above just describe how to pass
...
> >  arch/loongarch/kernel/acpi.c            | 324 ++++++++++++++++
...
> >  21 files changed, 2287 insertions(+)
...
> > new file mode 100644
> > index 000000000000..29e2214d5901
> > --- /dev/null
...
> > +
> > +#define acpi_os_ioremap ioremap
> > +
...
> > new file mode 100644
> > index 000000000000..3f77c937e9ad
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..bedeb3eb1157
> > --- /dev/null
...
> > new file mode 100644
> > index 000000000000..c1ac71034448
> > --- /dev/null
