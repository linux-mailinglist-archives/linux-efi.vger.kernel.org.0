...
Received: from vger.kernel.org (vger.kernel.org [23.128.96.18])
	by mail.lfdr.de (Postfix) with ESMTP id 138901B8A99
	for <lists+linux-efi@lfdr.de>; Sun, 26 Apr 2020 02:59:15 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726088AbgDZA7O (ORCPT <rfc822;lists+linux-efi@lfdr.de>);
        Sat, 25 Apr 2020 20:59:14 -0400
Received: from mga12.intel.com ([192.55.52.136]:49144 "EHLO mga12.intel.com"
        rhost-flags-OK-OK-OK-OK) by vger.kernel.org with ESMTP
        id S1726110AbgDZA7N (ORCPT <rfc822;linux-efi@vger.kernel.org>);
        Sat, 25 Apr 2020 20:59:13 -0400
IronPort-SDR: pjp5APXtbab6Ph/Z6csh6mxZc3jaNMdMQ2b+iFR2r8VJMqAD6A3UC2WjPH3mA4Jsq8VbMBi76O
 dvY24QgbWCKA==
X-Amp-Result: SKIPPED(no attachment in message)
X-Amp-File-Uploaded: False
Received: from fmsmga003.fm.intel.com ([10.253.24.29])
  by fmsmga106.fm.intel.com with ESMTP/TLS/ECDHE-RSA-AES256-GCM-SHA384; 25 Apr 2020 17:59:12 -0700
IronPort-SDR: oMy6/xETK4gfkanPJaAu7wlwN0ohSiqQWQE9RLLTAQSpijXmdM47fEOFVNHBpxrS6IrDDYWFbv
 HrEG9EvWUcEg==
X-ExtLoop1: 1
X-IronPort-AV: E=Sophos;i="5.73,318,1583222400"; 
   d="scan'208";a="301968949"
Received: from lkp-server01.sh.intel.com (HELO lkp-server01) ([10.239.97.150])
  by FMSMGA003.fm.intel.com with ESMTP; 25 Apr 2020 17:59:11 -0700
Received: from kbuild by lkp-server01 with local (Exim 4.89)
        (envelope-from <lkp@intel.com>)
        id 1jSVdW-0002PW-UM; Sun, 26 Apr 2020 08:59:10 +0800
Date:   Sun, 26 Apr 2020 08:58:31 +0800
From:   kbuild test robot <lkp@intel.com>
To:     Ard Biesheuvel <ardb@kernel.org>
Cc:     linux-efi@vger.kernel.org
Subject: [efi:next] BUILD SUCCESS 4eb8320bd1aaa7e69d039f2c251735e3ef0b9a38
Message-ID: <5ea4dcb7.G25Z00ELOYeRII+j%lkp@intel.com>
...
branch HEAD: 4eb8320bd1aaa7e69d039f2c251735e3ef0b9a38  efi: Move arch_tables check to caller
...
drivers/firmware/efi/libstub/efistub.h:680:44: sparse: sparse: incorrect type in argument 2 (different type sizes)
drivers/firmware/efi/libstub/efistub.h:682:44: sparse:    expected unsigned short const [usertype] *optstr
drivers/firmware/efi/libstub/efistub.h:682:44: sparse:    got char *
drivers/firmware/efi/libstub/efistub.h:682:44: sparse: sparse: incorrect type in argument 2 (different type sizes)

Warning ids grouped by kconfigs:

recent_errors
|-- x86_64-allmodconfig
|   |-- drivers-firmware-efi-libstub-efistub.h:sparse:expected-unsigned-short-const-usertype-optstr
|   |-- drivers-firmware-efi-libstub-efistub.h:sparse:got-char
|   `-- drivers-firmware-efi-libstub-efistub.h:sparse:sparse:incorrect-type-in-argument-(different-type-sizes)-expected-unsigned-short-const-usertype-optstr-got-ype-optstr
`-- x86_64-allyesconfig
    |-- drivers-firmware-efi-libstub-efistub.h:sparse:expected-unsigned-short-const-usertype-optstr
    |-- drivers-firmware-efi-libstub-efistub.h:sparse:got-char
    `-- drivers-firmware-efi-libstub-efistub.h:sparse:sparse:incorrect-type-in-argument-(different-type-sizes)-expected-unsigned-short-const-usertype-optstr-got-ype-optstr
