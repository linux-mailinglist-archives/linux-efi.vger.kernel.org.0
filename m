...
Received: from vger.kernel.org (vger.kernel.org [209.132.180.67])
	by mail.lfdr.de (Postfix) with ESMTP id C0BD666209
	for <lists+linux-efi@lfdr.de>; Fri, 12 Jul 2019 01:00:43 +0200 (CEST)
Received: (majordomo@vger.kernel.org) by vger.kernel.org via listexpand
        id S1726587AbfGKXAn (ORCPT <rfc822;lists+linux-efi@lfdr.de>);
        Thu, 11 Jul 2019 19:00:43 -0400
Received: from mx0a-00154904.pphosted.com ([148.163.133.20]:34520 "EHLO
        mx0a-00154904.pphosted.com" rhost-flags-OK-OK-OK-OK)
        by vger.kernel.org with ESMTP id S1730428AbfGKXAn (ORCPT
        <rfc822;linux-efi@vger.kernel.org>); Thu, 11 Jul 2019 19:00:43 -0400
Received: from pps.filterd (m0170392.ppops.net [127.0.0.1])
        by mx0a-00154904.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id x6BMxoXE014445
        for <linux-efi@vger.kernel.org>; Thu, 11 Jul 2019 19:00:41 -0400
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed; d=dell.com; h=from : to : cc :
 subject : date : message-id : references : in-reply-to : content-type :
 content-transfer-encoding : mime-version; s=smtpout1;
 bh=NHR3kYEmxi8Zo5i485EhnnhaOrIAItkuOjBiMSLYyHk=;
 b= Ig== 
Received: from mx0a-00154901.pphosted.com (mx0a-00154901.pphosted.com [67.231.149.39])
        by mx0a-00154904.pphosted.com with ESMTP id 2tpambgu3j-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=NOT)
        for <linux-efi@vger.kernel.org>; Thu, 11 Jul 2019 19:00:41 -0400
Received: from pps.filterd (m0133268.ppops.net [127.0.0.1])
        by mx0a-00154901.pphosted.com (8.16.0.27/8.16.0.27) with SMTP id x6BN0aJO194352
        for <linux-efi@vger.kernel.org>; Thu, 11 Jul 2019 19:00:41 -0400
Received: from ausc60ps301.us.dell.com (ausc60ps301.us.dell.com [143.166.148.206])
        by mx0a-00154901.pphosted.com with ESMTP id 2tp1njcfrt-1
        (version=TLSv1.2 cipher=ECDHE-RSA-AES256-GCM-SHA384 bits=256 verify=OK)
        for <linux-efi@vger.kernel.org>; Thu, 11 Jul 2019 19:00:41 -0400
X-LoopCount0: from 10.166.132.128
X-PREM-Routing: D-Outbound
X-IronPort-AV: E=Sophos;i="5.60,349,1549951200"; 
   d="scan'208";a="1328049042"
From:   <Mario.Limonciello@dell.com>
To:     <Narendra.K@dell.com>, <linux-efi@vger.kernel.org>,
...
Thread-Index: AQHVN1GRuuFZ1FIGT0iRonG1BybW8KbGCe0g
Date:   Thu, 11 Jul 2019 23:00:37 +0000
Message-ID: <3b26bccb3caa4360a552f1dc57b9ac24@AUSX13MPC105.AMER.DELL.COM>
References: <20190710185853.GA2645@localhost.localdomain>
In-Reply-To: <20190710185853.GA2645@localhost.localdomain>
...
msip_labels: MSIP_Label_17cb76b2-10b8-4fe1-93d4-2202842406cd_Enabled=True;
 ...
 MSIP_Label_17cb76b2-10b8-4fe1-93d4-2202842406cd_SetDate=2019-07-11T22:59:27.6167035Z;
...
X-Proofpoint-Spam-Details: rule=outbound_notspam policy=outbound score=0 priorityscore=1501
 ...
 scancount=1 engine=8.0.1-1810050000 definitions=main-1907110250
X-Proofpoint-Spam-Details: rule=notspam policy=default score=0 priorityscore=1501 malwarescore=0
 suspectscore=0 phishscore=0 bulkscore=0 spamscore=0 clxscore=1011
 lowpriorityscore=0 mlxscore=0 impostorscore=0 mlxlogscore=999 adultscore=0
 classifier=spam adjust=0 reason=mlx scancount=1 engine=8.0.1-1810050000
 definitions=main-1907110250
...
> To: linux-efi@vger.kernel.org; ard.biesheuvel@linaro.org; pjones@redhat.c=
om
...
>=20
> System firmware advertises the address of the 'Runtime Configuration Inte=
rface
> table version 2 (RCI2)' via an EFI Configuration Table entry. This code r=
etrieves
> the RCI2 table from the address and exports it to sysfs as a binary attri=
bute 'rci2'
> under /sys/firmware/efi/tables directory.
> The approach adopted is similar to the attribute 'DMI' under
> /sys/firmware/dmi/tables.
>=20
> RCI2 table contains BIOS HII in XML format and is used to populate BIOS s=
etup
...
be
> changed, I will resubmit the patch after changing it to implement the sug=
gestion.
>=20
...
> - Removed calling 'efi_rci2_sysfs_init' from drivers/firmware/efi/efi.c a=
nd made
...
> - Removed the string 'rci2' from the common_tables array so that it is no=
t
> printed in dmesg.
...
> diff --git a/arch/x86/platform/efi/efi.c b/arch/x86/platform/efi/efi.c in=
dex
...
> @@ -25,6 +25,7 @@ obj-$(CONFIG_EFI_BOOTLOADER_CONTROL)	+=3D
> efibc.o
...
>  };
>=20
> diff --git a/drivers/firmware/efi/rci2_table.c b/drivers/firmware/efi/rci=
2_table.c
...
> +	}
> +
> +	rci2_base =3D memremap(rci2_table_phys, rci2_table_len,
> MEMREMAP_WB);
> +	if (!rci2_base) {
